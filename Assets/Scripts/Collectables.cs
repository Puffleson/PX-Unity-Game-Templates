...
public class Collectables : MonoBehaviour
{
    ...
    {
        scoreText.text = "Score: "+startingScore; // Sets the content of scoreText as the starting score of '0'
    }
    ...
    private void updateScoreUI()
    {
        ...
        scoreText.text = "Score: "+ currentScore;   // Changes the content to the current new score calculated
    }
}
