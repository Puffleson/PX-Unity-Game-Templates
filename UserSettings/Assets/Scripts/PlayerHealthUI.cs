...
public class PlayerHealthUI : MonoBehaviour
{
    ...
    public Color m_FullHealthColour = Color.green;
    public Color m_ZeroHealthColour = Color.red;
    ...
    private void Update()
    {
        ...
        if(currentHealth != minHealth)
        {
            ...
            healthNumberText.text = healthNumberText.text + currentHealth + "%";
            setHealth();       // Calls setHealth(); function
            setHealthUI();      // Calls setHealthUI(); function
        }    
    }
    ...
    private void setHealthUI()
    {
        ...
        m_FillImage.color = Color.Lerp(m_ZeroHealthColour, m_FullHealthColour, currentHealth / maxHealth);       // Changes the health bar colour depending on the value of the current health, from Green to Red
    }
}
